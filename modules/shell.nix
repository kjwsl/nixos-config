...
Directory: $dir" \
  ...
  home.file.".config/fish/alias.fish".source = ~/.local/share/chezmoi/dot_config/fish/alias.fish;
  home.file.".config/fish/functions.fish".source = ~/.local/share/chezmoi/dot_config/fish/functions.fish;
}